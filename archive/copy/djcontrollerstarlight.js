...
class djcontrollerstarlight extends controller {
    ...
    handle(msg)
    {
		console.log(`[MIDI IN] Type: ${msg._type}, Ch: ${msg.channel}, Note/CC: ${msg.note || msg.controller}, Value: ${msg.velocity || msg.value}`);
		...
		console.log(`[MAPPING] Looking for ID: ${id}, Type: ${msg._type}`);
		console.log(`[MAPPING] Available elements: ${this[this.CurrentLayerName].length}`);
